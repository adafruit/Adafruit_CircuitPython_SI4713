#!/usr/bin/python3
#
# SPDX-FileCopyrightText: 2021 Stefan Heimers
...
si_reset = digitalio.DigitalInOut(
    board.D5
)  # GPIO5, = pin 29 am Raspi, nicht nötig bei Kondensatorreset (Qwiic board)
# si_reset=None

tx = adafruit_si4713.SI4713(
    i2c, address=si_address, reset=si_reset, timeout_s=0.5, audio="digital"
)
if not tx:
